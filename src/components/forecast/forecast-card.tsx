...
const ForeCastCard: FC<IForeCastCard> = ({ forecastData }) => {
  ...
  return (
    <div
      className={
        "flex flex-col items-center justiify-center rounded-xl border border-primary w-32 h-56 hover:bg-primary/20 cursor-pointer transition-all ease-in-out duration-150 py-5 px-2"
      }
    >
      <div>
